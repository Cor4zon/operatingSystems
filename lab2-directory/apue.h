 /*
    * Наш заголовочный файл, который подключается перед любыми
    * стандартными системными заголовочными файлами
    */
#ifndef _APUE_H
#define _APUE_H
...
/*
 * Права доступа по умолчанию к создаваемым файлам.
 */
...
/*
 * Прототипы наших собственных функций.
 */
